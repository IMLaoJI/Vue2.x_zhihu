...
<template>
  <div class="main-list" id="foo">
    ...
    <list-header :show-sidebar.sync="showSidebar" :title="title" :tip="tip" :icon-display="iconDisplay" @show-menu-slide="showMenuSlide" > </list-header>
    <!--侧边栏-->
    <side-bar :show-sidebar.sync="showSidebar" :tip.sync="tip"  @hide-side-bar="hideSideBar" @changetip="changeTip"> </side-bar>
